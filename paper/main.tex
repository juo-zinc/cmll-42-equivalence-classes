...
Define
\[
X := \{\,(\tau,t)\mid \tau \in \mathfrak{S}(P),\ t \in \Z_3^{\,4},\ t_0+t_1+t_2+t_3\equiv 0 \pmod 3\,\}.
\]
\end{definition}

\begin{proposition}[Cardinality of $X$]\label{prop:X-card}
We have $|X|=4!\cdot 3^3=648$.
\end{proposition}

\begin{proof}
There are $4!=24$ choices for $\tau$. For $t$, choose $(t_0,t_1,t_2)\in (\Zthree)^{\,3}$ arbitrarily (giving $3^3$ choices),
